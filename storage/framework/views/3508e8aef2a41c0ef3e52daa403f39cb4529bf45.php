        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" maxlength="100" name="fullname" class="form-control" id="firstName" placeholder="" value="<?php echo e($users->name); ?>" required>
            ...
            <div class="col-12">
              ...
              <input type="email" name="email" maxlength="100" value="<?php echo e($users->email); ?>" class="form-control" id="email" placeholder="you@pleague.com.my">
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input maxlength="50" name="password" value="<?php echo e($users->password); ?>" type="text" class="form-control" id="address" placeholder="Address" required>
              <div class="invalid-feedback">
...
<?php /**PATH C:\xampp\htdocs\miniproject\resources\views/useredit.blade.php ENDPATH**/ ?>